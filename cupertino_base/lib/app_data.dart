...
class AppData with ChangeNotifier {
    ...
    bool dataReady (String type) {
        switch (type) {
            case 'Example':       return readyExample;
        }
        return false;
    }
    ...
    dynamic getData (String type) {
        switch (type) {
            case 'Example':       return dataExample;
        }
        return;
    }
    ...
    void load (String type) async {
        ...
        var file = "";
        switch (type) {
            case 'Example':     file = "assets/data/example.json"; break;
        }
        ...
        // Set data
        switch (type) {
            case 'Example':     readyExample = true;    dataExample = fileData; break;
        }
